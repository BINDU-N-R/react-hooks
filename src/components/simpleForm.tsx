...
const SimpleForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.hobbies.forEach((hobby: { name: any; }, index: string | number) => {
      if (!hobby.name) {
  ...
  return (
    ...
    >
      ...
      <div>
        <label>Hobbies</label>
        {formData.hobbies.map((hobby: { name: string | number | readonly string[] | undefined; }, index: React.Key | null | undefined) => (
          <div key={index}>
            <input
              name="name"
              value={hobby.name}
